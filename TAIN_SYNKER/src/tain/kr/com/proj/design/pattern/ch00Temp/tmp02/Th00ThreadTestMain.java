 ...
 *
 * <PRE>
 *   -. FileName   : Th00ThreadTestMain.java
 *   -. Package    : tain.kr.com.proj.design.pattern.ch00Temp.tmp02
 *   -. Comment    :
 *   -. Author     : taincokr
 ...
 *
 */
public class Th00ThreadTestMain {

	private static boolean flag = true;

	private static final Logger log = Logger.getLogger(Th00ThreadTestMain.class);
	...
	private static void test01(String[] args) throws Exception {
		...
		if (flag) {
			Thread thread = new Thread(new MyRunnable("KANG-3"));
			thread.start();
			thread.join();
		}
