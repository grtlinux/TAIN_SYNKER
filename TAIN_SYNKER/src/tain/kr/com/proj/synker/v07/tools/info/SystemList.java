...
public class SystemList {
	...
	private static final Logger log = Logger.getLogger(SystemList.class);

	///////////////////////////////////////////////////////////////////////////////////////////////
	
	private static final String KEY_DESC = "tain.kr.system.list.desc";
	private static final String KEY_DATE = "tain.kr.system.list.date";
	private static final String KEY_VERSION = "tain.kr.system.list.ver";
	
	private String desc = null;
	private String date = null;
	private String version = null;
	
	public SystemList() throws Exception {
		if (flag) {
	...
	private static SystemList instance = null;
	
	public static synchronized SystemList getInstance() throws Exception {
		
		if (instance == null) {
			instance = new SystemList();
		}
